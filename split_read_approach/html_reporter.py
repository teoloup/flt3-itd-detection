...
Creates visual HTML reports for ITD detection results
"""
...
class HTMLReporter:
    ...
    def _create_summary_section(self, results: List['ValidationResult'], 
        ...
        if num_itds > 0:
            ...
            total_itd_reads = sum(r.itd_coverage for r in results)
        ...
        <div class="summary-box">
            ...
            <div class="metric">
                <span class="metric-label">ITD Supporting Reads:</span>
                <span class="metric-value">{total_itd_reads}</span>
            </div>
        """
        ...
        for i, result in enumerate(results, 1):
            ...
            <div class="itd-card">
                ...
                <table>
                    ...
                    <tr>
                        <td>Length</td>
                        <td>{result.duplication_length} bp</td>
                    </tr>
                    <tr>
                        <td>Position</td>
